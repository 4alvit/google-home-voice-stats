...
Keep a dated deployment record with HA version, IGW version, selected TTS/Cast
entity names, and which checks passed. Do not include tokens or full request
